...
Característica: Utilitzar Ofertes de NxM
  ...
  Escenari: Utilitzar oferta MxN sobre una venda automaticament
    Donat s'afegeix a la linia de venda 3 unitats del producte amb codi de barres "333"
  ...
  Escenari: Afegir Producte a oferta
